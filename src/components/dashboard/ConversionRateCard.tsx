  ...
  return (
    <Card className="bg-card-dark border-border p-4 md:p-6 rounded-2xl md:rounded-3xl hover:border-primary/30 transition-all">
      <div className="flex items-center justify-between mb-3 md:mb-4">
        <h3 className="text-sm md:text-lg font-semibold text-foreground">Conversão</h3>
        <Target className="w-4 h-4 md:w-5 md:h-5 text-primary" />
      </div>

      <div className="flex items-baseline gap-2 mb-3 md:mb-4">
        <span className="text-3xl md:text-4xl font-bold text-foreground">{conversionRate.toFixed(1)}</span>
