        ...
        <AccordionItem value="retrospectiva" className="border-none">
          ...
          <AccordionContent className="px-6 pb-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {/* Keep Doing */}
              <Card className="bg-green-950/30 border-green-500/30 p-4 rounded-xl">
              ...
              {/* Stop Doing */}
              <Card className="bg-red-950/30 border-red-500/30 p-4 rounded-xl">
                <div className="flex items-center gap-2 mb-4">
              ...
              {/* Start Doing */}
              <Card className="bg-blue-950/30 border-blue-500/30 p-4 rounded-xl">
                <div className="flex items-center gap-2 mb-4">
