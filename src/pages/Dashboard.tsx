...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 z-50 bg-background border-b border-border px-6 py-4">
        <div className="flex items-center justify-between max-w-[1600px] mx-auto">
          {/* Logo */}
          <div className="flex items-center gap-2">
            <div className="w-10 h-10 rounded-full bg-card flex items-center justify-center">
              <div className="w-6 h-6 border-2 border-foreground rounded-full relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-3 h-0.5 bg-foreground rotate-45"></div>
                  <div className="w-3 h-0.5 bg-foreground -rotate-45"></div>
                </div>
              </div>
            </div>
            <span className="text-2xl font-bold">ETER</span>
          </div>
      ...
      <main className="pt-24 px-6 pb-12 max-w-[1600px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
          {/* Receita Total Card */}
          <Card className="bg-card p-6 rounded-[20px] hover:scale-[1.02] transition-transform">
            <div className="flex items-start justify-between mb-4">
              <h3 className="text-lg font-semibold text-card-foreground">Receita Total</h3>
              <div className="flex items-center gap-2">
            ...
            <div className="mb-2">
              ...
              <span className="text-5xl font-bold text-foreground">320.0K</span>
            </div>
            
            <div className="flex items-center justify-between mb-3">
              <span className="text-sm text-muted-foreground">Meta: 500k</span>
            </div>
          ...
          <Card className="bg-card p-6 rounded-[20px] hover:scale-[1.02] transition-transform">
            <div className="flex items-start justify-between mb-4">
              <h3 className="text-lg font-semibold text-card-foreground">Conversão<br/>& Funil</h3>
              <div className="flex items-center gap-2">
                <Button variant="ghost" size="icon" className="h-8 w-8">
                  <Bell className="w-4 h-4 text-card-foreground" />
                </Button>
            ...
            <div className="flex items-center gap-4 mb-4">
              <div>
                ...
                <div className="text-xs text-muted-foreground">Campanhas<br/>ativas totais</div>
              </div>
              ...
              <div className="flex-1 flex items-center gap-2">
                ...
                <div className="w-16 h-16 rounded-full bg-secondary flex items-center justify-center">
                  <div className="text-xs text-foreground font-semibold">~40%<br/>ROI</div>
                </div>
              </div>
            </div>
          </Card>
          ...
          <Card className="bg-card-dark p-6 rounded-[20px] hover:scale-[1.02] transition-transform">
            <div className="flex items-start justify-between mb-4">
              <h3 className="text-lg font-semibold text-card-dark-foreground">Engajamento<br/>das Redes</h3>
              <div className="flex items-center gap-2">
                <Button variant="ghost" size="icon" className="h-8 w-8">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-card-dark-foreground">Instagram: 70</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 rounded-full bg-muted"></div>
                <span className="text-sm text-card-dark-foreground">Youtube: 30</span>
              </div>
            </div>
          </Card>
          ...
          <Card className="bg-card-dark p-6 rounded-[20px] hover:scale-[1.02] transition-transform">
            <div className="flex items-start justify-between mb-4">
              <h3 className="text-lg font-semibold text-card-dark-foreground">Lançamentos</h3>
              <div className="flex items-center gap-2">
                <Button variant="ghost" size="icon" className="h-8 w-8">
                  <Bell className="w-4 h-4 text-card-dark-foreground" />
                </Button>
            ...
            <div className="flex items-center justify-between text-xs text-muted-foreground mt-2">
              {launchData.map((item, idx) => (
                <span key={idx} className={item.highlighted ? "text-primary font-bold border border-primary rounded px-1" : ""}>
                  {item.month}
                </span>
              ))}
            </div>
        ...
        {/* IMOVI Card - Large */}
        <div className="mb-6">
          <Card className="bg-card p-8 rounded-[20px] hover:scale-[1.01] transition-transform">
            <div className="flex items-start justify-between mb-6">
              <div>
                <h2 className="text-2xl font-bold text-card-foreground mb-1">IMOVI</h2>
                <p className="text-sm text-muted-foreground">Índice de Movimento e Influência</p>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="flex flex-col justify-center items-center bg-background rounded-xl p-6">
                <div className="text-xs text-muted-foreground mb-2">ÍNDICE IMOVI</div>
                <div className="text-7xl font-bold text-card-foreground mb-4">64</div>
                
                <div className="space-y-2 w-full">
                  <div className="bg-primary text-primary-foreground text-sm font-semibold px-3 py-1.5 rounded-full flex items-center justify-between">
                    <span>55% Growth</span>
                    <ArrowUpRight className="w-4 h-4" />
                  </div>
                  <div className="bg-primary/80 text-primary-foreground text-sm font-semibold px-3 py-1.5 rounded-full flex items-center justify-between">
                    <span>35% Leads</span>
                    <ArrowUpRight className="w-4 h-4" />
                  </div>
                  <div className="bg-primary/60 text-primary-foreground text-sm font-semibold px-3 py-1.5 rounded-full flex items-center justify-between">
                    <span>40% Engage</span>
                    <ArrowUpRight className="w-4 h-4" />
                  </div>
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          {/* Insights IA Card */}
          <Card className="lg:col-span-3 bg-card-dark p-8 rounded-[20px]">
            <div className="flex items-start justify-between mb-6">
              <div>
                <h2 className="text-2xl font-bold text-card-dark-foreground mb-1">Insights IA</h2>
                <p className="text-sm text-muted-foreground">Impulsione seu Movimento com nossa IA</p>
              </div>
